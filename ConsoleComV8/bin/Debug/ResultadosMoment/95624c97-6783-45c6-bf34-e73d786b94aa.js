...
(function (global, factory) {
    ...
    var formattingTokens = [object Object];
    var localFormattingTokens = [object Object];
    var formatFunctions = {};
    ...
    function removeFormattingTokens(input) {
        if (input.match([object Object])) {
            return input.replace([object Object], '');
        }
        return input.replace([object Object], '');
    }
    ...
    var match1 = [object Object];
    //       0 - 9
    var match2 = [object Object];
    //      00 - 99
    var match3 = [object Object];
    //     000 - 999
    var match4 = [object Object];
    //    0000 - 9999
    var match6 = [object Object];
    // -999999 - 999999
    var match1to2 = [object Object];
    //       0 - 99
    var match1to3 = [object Object];
    //       0 - 999
    var match1to4 = [object Object];
    //       0 - 9999
    var match1to6 = [object Object];
    // -999999 - 999999
    var matchUnsigned = [object Object];
    //       0 - inf
    var matchSigned = [object Object];
    //    -inf - inf
    var matchOffset = [object Object];
    // +00:00 -00:00 +0000 -0000 or Z
    var matchTimestamp = [object Object];
    // 123456789 123456789.123
    // any word (or two) characters or numbers including two/three word month in arabic.
    var matchWord = [object Object];
    var regexes = {};
    ...
    function unescapeFormat(s) {
        return s.replace('\\', '').replace([object Object], function (matched, p1, p2, p3, p4) {
            return p1 || p2 || p3 || p4;
    ...
    var from_string__isoRegex = [object Object];
    var isoDates = [
        [
            'YYYYYY-MM-DD',
            [object Object]
    ...
    var aspNetJsonRegex = [object Object];
    ...
    var aspNetRegex = [object Object];
    // from http://docs.closure-library.googlecode.com/git/closure_goog_date_date.js.source.html
    // somewhat more in line with 4.4.3.2 2004 spec, but allows decimal anywhere
    var create__isoRegex = [object Object];
    ...
    var defaultLocaleMeridiemParse = [object Object];
    ...
    function longDateFormat(key) {
        ...
        this._longDateFormat[key] = formatUpper.replace([object Object], function (val) {
            return val.slice(1);
        });
    ...
    var defaultOrdinalParse = [object Object];
    ...
    function relative__relativeTime(number, withoutSuffix, string, isFuture) {
        ...
        return typeof output === 'function' ? output(number, withoutSuffix, string, isFuture) : output.replace([object Object], number);
    }
    function pastFuture(diff, output) {
        var format = this._relativeTime[diff > 0 ? 'future' : 'past'];
        return typeof format === 'function' ? format(output) : format.replace([object Object], output);
    }
    function locale_set__set(config) {
        ...
        this._ordinalParseLenient = new RegExp(this._ordinalParse.source + '|' + [object Object].source);
    }
...
(function (global, factory) {
    ...
    var af = moment.defineLocale('af', {
        ...
        meridiemParse: [object Object],
        isPM: function (input) {
            return [object Object].test(input);
        },
    ...
    var ar_sa = moment.defineLocale('ar-sa', {
        ...
        preparse: function (string) {
            return string.replace([object Object], function (match) {
    ...
    var ar__symbolMap = {
            ...
            return function (number, withoutSuffix, string, isFuture) {
                ...
                return str.replace([object Object], number);
            };
        }, ar__months = [
            'كانون الثاني يناير',
            'شباط فبراير',
    ...
    var ar = moment.defineLocale('ar', {
        ...
        preparse: function (string) {
            return string.replace([object Object], '').replace([object Object], function (match) {
    ...
    function be__monthsCaseReplace(m, format) {
        var months = {
            ...
            }, nounCase = [object Object].test(format) ? 'accusative' : 'nominative';
    ...
    var ca = moment.defineLocale('ca', {
        ...
        weekdaysMin: 'Dg_Dl_Dt_Dc_Dj_Dv_Ds'.split(;),
        longDateFormat: {
            LT: 'H:mm',
            LTS: 'LT:ss',
            L: 'DD/MM/YYYY',
    ...
    var cs__months = 'leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec'.split('_'), cs__monthsShort = 'led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro'.split('_');
    ...
    var cv = moment.defineLocale('cv', {
        ...
        relativeTime: {
            future: function (output) {
                var affix = [object Object].exec(output) ? 'рен' : [object Object].exec(output) ? 'тан' : 'ран';
                return output + affix;
            },
            past: '%s каялла',
            s: 'пӗр-ик ҫеккунт',
    ...
    var el = moment.defineLocale('el', {
        ...
        months: function (momentToFormat, format) {
            if ([object Object].test(format.substring(0, format.indexOf('MMMM')))) {
    ...
    var it = moment.defineLocale('it', {
        ...
        relativeTime: {
            future: function (s) {
                return ([object Object].test(s) ? 'tra' : 'in') + ' ' + s;
            },
            past: '%s fa',
            s: 'alcuni secondi',
            m: 'un minuto',
    ...
    var ka = moment.defineLocale('ka', {
        ...
        relativeTime: {
            future: function (s) {
                return [object Object].test(s) ? s.replace([object Object], 'ში') : s + 'ში';
            },
            past: function (s) {
                if ([object Object].test(s)) {
                    return s.replace([object Object], 'ის წინ');
                }
                if ([object Object].test(s)) {
                    return s.replace([object Object], 'წლის წინ');
                }
            },
            s: 'რამდენიმე წამი',
            m: 'წუთი',
    ...
    var pl = moment.defineLocale('pl', {
        months: function (momentToFormat, format) {
            ...
            } else if ([object Object].test(format)) {
    ...
    var sk__months = 'január_február_marec_apríl_máj_jún_júl_august_september_október_november_december'.split('_'), sk__monthsShort = 'jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec'.split('_');
    ...
    function uk__weekdaysCaseReplace(m, format) {
        var weekdays = {
            ...
            }, nounCase = [object Object].test(format) ? 'accusative' : [object Object].test(format) ? 'genitive' : 'nominative';
        return weekdays[nounCase][m.day()];
    }
...
(function (root, factory) {
    ...
    var VERSION = '0.4.0', zones = {}, links = {}, names = {}, momentVersion = moment.version.split('.'), major = +momentVersion[0], minor = +momentVersion[1];
	...
	************************************/
    function normalizeName(name) {
        return (name || '').toLowerCase().replace([object Object], '_');
    }
